      ...
      <div class="row">
        <ul class="nav nav-tabs ">
          <div class="col-3">
            <li class="nav-item">
              <router-link to="/">
                <a class="nav-link" href="/#/contausuariocadastrardoacao"
                  >Inicio</a
                >
              </router-link>
            </li>
            ...
            <div class="container tamanho">
              <div class="col-md-12 position-relative mt-3 mx-auto">
                <label
                  ...
                  class="form-label roxoLetra mx-1"
                  >Seleciona o Material</label
                >
              ...
              <div class="row row-cols-2 ">
                <div class="col bot setarPadding  mx-auto">
                  <label for="formQuantity" class="roxoLetra mx-1"
                    >Selecione a Quantidade</label
                  >
                  <select
                ...
                <div
                  class="col bot setarPadding  mx-auto"
